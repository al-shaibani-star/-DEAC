...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/amrde_overview.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/emrcgc_overview.png}
...
(ii)~\emph{Internal--external gap.} The QualityGate decides on internal metrics (MOD, SIL, BAL), which do not align perfectly with ARI; this is why on 2 of 12 datasets (Wine, Optdigits) DEAC keeps the baseline rather than improving on it.
